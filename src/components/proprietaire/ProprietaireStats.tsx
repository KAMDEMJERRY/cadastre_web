...
export default function ProprietaireStats({ stats }: ProprietaireStatsProps) {
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 justify-items-center">
  {statsConfig.map((stat, index) => {
    ...
    return (
      <Card key={index} className="bg-white border-slate-200 hover:shadow-lg transition-all duration-300 hover:shadow-blue-100 hover:-translate-y-1 w-full max-w-md">
